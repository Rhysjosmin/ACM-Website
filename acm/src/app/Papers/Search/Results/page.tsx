...
function PaperResult() {
  return (
    <button
      className={`bg-[#161616] hover:bg-[#1b1b1b] border transition border-transparent hover:border-[#333333] ${spaceGrotesk.className} flex h-32 md:h-20 w-[calc(100vw-8rem)] gap-4 p-4`}
    >
      <div className="flex-grow">
        ...
        <span className="flex gap-2 text-xs font-thin">
          <Link
            href={""}
            className="text-[#6284FF] hover:text-[#96adff] underline"
          >
            Yunhui Zhou
          </Link>
          <Link
